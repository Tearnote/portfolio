...
A voluntary mailing list is available for clients interested in knowing about service availability. The intended usecase is sending emails about periods of time when no progress will be made on commissions.
